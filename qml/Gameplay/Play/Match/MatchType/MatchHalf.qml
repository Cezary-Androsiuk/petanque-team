...
Item {
    ...
    ListView{
        ...
        delegate: Item{
            ...
            //         value: matchHalf.matchPoints.points[index]
            //         onValueChanged: {
            //             matchHalf.setPFP(index, value);
            ...
            // readonly property var playersInGroup: matchHalf.matchPoints.usedPlayersInGroups[groupIndex]
